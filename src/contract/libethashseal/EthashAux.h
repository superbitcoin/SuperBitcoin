...
namespace dev
{
    namespace eth
    {
        ...
        struct DAGChannel : public LogChannel
        {
        ...
        public:
            ...
            {
                return std::make_pair(get()->m_generatingFullNumber, get()->m_fullProgress);
            }
            ...
            static FullType full(h256 const &_seedHash, bool _createIfMissing = false,
