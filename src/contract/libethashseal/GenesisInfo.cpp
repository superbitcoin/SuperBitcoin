...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::sbtcMainNetwork: return c_genesisInfoSbtcMainNetwork;
	case Network::sbtcTestNetwork: return c_genesisInfoSbtcTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::sbtcMainNetwork: return c_genesisStateRootSbtcMainNetwork;
	case Network::sbtcTestNetwork: return c_genesisStateRootSbtcTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
