...
#include <utils/cryptopp/aes.h>
#include <utils/cryptopp/pwdbased.h>
#include <utils/cryptopp/sha.h>
#include <utils/cryptopp/modes.h>
...
bytesSec
dev::scrypt(std::string const &_pass, bytes const &_salt, uint64_t _n, uint32_t _r, uint32_t _p, unsigned _dkLen)
{
    bytesSec ret(_dkLen);
    if (libscrypt_scrypt(
