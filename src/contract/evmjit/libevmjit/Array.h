    ...
    namespace eth
    {
        namespace jit
        {
            ...
            public:
                ...
                {
                    m_pushFunc.call(m_builder, {m_array, _value});
                }
                ...
                {
                    return m_getFunc.call(m_builder, {m_array, _index});
                }
                ...
                void free()
                {
                    m_freeFunc.call(m_builder, {m_array});
                }
            ...
            private:
                ...
                LazyFunction m_pushFunc = {[this]()
                                           { return createArrayPushFunc(); }};
                LazyFunction m_setFunc = {[this]()
                                          { return createArraySetFunc(); }};
                LazyFunction m_getPtrFunc = {[this]()
                                             { return createGetPtrFunc(); }};
                LazyFunction m_getFunc = {[this]()
                                          { return createArrayGetFunc(); }};
                LazyFunction m_freeFunc = {[this]()
                                           { return createFreeFunc(); }};
                LazyFunction m_extendFunc = {[this]()
                                             { return createExtendFunc(); }};
                LazyFunction m_reallocFunc = {[this]()
