    ...
    namespace eth
    {
        namespace jit
        {
                    ...
                    m_mode(mode)
            {
                ...
                m_gasCheckFunc = llvm::Function::Create(llvm::FunctionType::get(Type::Void, gasCheckArgs, false),
            ...
            void GasMeter::count(Instruction _inst)
            {
                if (!m_checkCall)
                {
                    ...
                    m_checkCall = m_builder.CreateCall(m_gasCheckFunc,
                                                       {m_runtimeManager.getGasPtr(), llvm::UndefValue::get(Type::Gas),
            ...
            void GasMeter::countExp(llvm::Value *_exponent)
            {
                ...
                auto sigBytes = m_builder.CreateUDiv(m_builder.CreateAdd(sigBits, m_builder.getInt64(7)),
                                                     m_builder.getInt64(8));
            ...
            void GasMeter::countSStore(Ext &_ext, llvm::Value *_index, llvm::Value *_newValue)
            {
                ...
                auto cost = m_builder.CreateSelect(isInsert, m_builder.getInt64(JITSchedule::sstoreSetGas::value),
            ...
            void GasMeter::countLogData(llvm::Value *_dataLength)
            {
                ...
                count(m_builder.CreateNUWMul(_dataLength,
                                             Constant::get(JITSchedule::logDataGas::value))); // TODO: Use i64
            }
            ...
            void GasMeter::countSha3Data(llvm::Value *_dataLength)
            {
                ...
                auto words64 = m_builder.CreateUDiv(m_builder.CreateNUWAdd(dataLength64, m_builder.getInt64(31)),
            ...
            void GasMeter::commitCostBlock()
            {
                ...
                if (m_checkCall)
                {
                    ...
                    m_checkCall->setArgOperand(1,
                                               m_builder.getInt64(m_blockCost)); // Update block cost in gas check call
            ...
            void
            GasMeter::countMemory(llvm::Value *_additionalMemoryInWords, llvm::Value *_jmpBuf, llvm::Value *_gasPtr)
            {
