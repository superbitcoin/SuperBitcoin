    ...
    namespace evmjit
    {
        ...
        namespace
        {
            ...
            public:
                ...
                ExecFunc
                compile(evm_mode _mode, byte const *_code, uint64_t _codeSize, std::string const &_codeIdentifier);
