    ...
    namespace shh
    {
        ...
        */
        ...
        public:
            ...
            {
                return shiftBytes(RLPStream().append(_r).out());
            }
        ...
        public:
            ...
            TopicFilter(Topics const &_m)
            {
                ...
                for (auto const &h: _m)
                    m_topicMasks.back().push_back(std::make_pair(abridge(h), h ? ~AbridgedTopic() : AbridgedTopic()));
            }
