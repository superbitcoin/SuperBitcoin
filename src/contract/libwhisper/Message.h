...
namespace dev
{
    namespace shh
    {
        ...
        public:
            ...
            {
                _s.appendList(_withNonce ? 5 : 4) << m_expiry << m_ttl << m_topic << m_data;
                if (_withNonce)
                    _s << m_nonce;
            }
            ...
            {
                return m_expiry <= utcTime();
            }

        private:
            Envelope(unsigned _exp, unsigned _ttl, AbridgedTopics const &_topic) : m_expiry(_exp), m_ttl(_ttl),
                                                                                   m_topic(_topic)
            {
            }
        ...
        public:
            ...
            Envelope
            seal(Secret const &_from, Topics const &_topics, unsigned _ttl = 50, unsigned _workToProve = 50) const;
            ...
            {
                return seal(Secret(), _topics, _ttl, _workToProve);
            }
            ...
            Envelope sealTo(Secret const &_from, Public _to, Topics const &_topics, unsigned _ttl = 50,
