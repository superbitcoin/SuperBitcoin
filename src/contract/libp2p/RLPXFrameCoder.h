    ...
    namespace p2p
    {
        ...
        public:
            ...
            RLPXFrameCoder(bool _originated, h512 const &_remoteEphemeral, h256 const &_remoteNonce,
                           crypto::ECDHE const &_ephemeral, h256 const &_nonce, bytesConstRef _ackCipher,
            ...
            void writeFrame(uint16_t _protocolType, uint16_t _seqId, uint32_t _totalSize, bytesConstRef _payload,
                            bytes &o_bytes);
