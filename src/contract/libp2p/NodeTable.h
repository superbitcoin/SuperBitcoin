    ...
    namespace p2p
    {
        ...
        private:
            ...
            static unsigned const s_bins =
                    s_bits - 1;                                ///< Size of m_state (excludes root, which is us).
            ...
            std::chrono::milliseconds const c_evictionCheckInterval = std::chrono::milliseconds(
                    75);    ///< Interval at which eviction timeouts are checked.
        ...
        inline std::ostream &operator<<(std::ostream &_out, NodeTable const &_nodeTable)
        {
            _out << _nodeTable.center().address() << "\t" << "0\t" << _nodeTable.center().endpoint.address << ":"
        ...
        struct DiscoveryDatagram : public RLPXDatagramFace
        {
            ...
            DiscoveryDatagram(bi::udp::endpoint const &_to) : RLPXDatagramFace(_to),
                                                              ts(futureFromEpoch(std::chrono::seconds(60)))
            {
            }
            ...
            /// Decodes UDP packets.
            static std::unique_ptr<DiscoveryDatagram>
            interpretUDP(bi::udp::endpoint const &_from, bytesConstRef _packet);
        };
        ...
        struct PingNode : DiscoveryDatagram
        {
            ...
            PingNode(NodeIPEndpoint const &_src, NodeIPEndpoint const &_dest) : DiscoveryDatagram(_dest), source(_src),
                                                                                destination(_dest)
            {
            }

            PingNode(bi::udp::endpoint const &_from, NodeID const &_fromid, h256 const &_echo) : DiscoveryDatagram(
                    _from, _fromid, _echo)
            {
            }
        ...
        struct Pong : DiscoveryDatagram
        {
            ...
            Pong(bi::udp::endpoint const &_from, NodeID const &_fromid, h256 const &_echo) : DiscoveryDatagram(_from,
                                                                                                               _fromid,
                                                                                                               _echo)
            {
            }
        ...
        struct FindNode : DiscoveryDatagram
        {
            ...
            FindNode(bi::udp::endpoint const &_from, NodeID const &_fromid, h256 const &_echo) : DiscoveryDatagram(
                    _from, _fromid, _echo)
            {
            }
        ...
        struct Neighbours : DiscoveryDatagram
        {
            Neighbours(bi::udp::endpoint _to, std::vector<std::shared_ptr<NodeEntry>> const &_nearest,
                       unsigned _offset = 0, unsigned _limit = 0) : DiscoveryDatagram(_to)
            {
            ...
            Neighbours(bi::udp::endpoint const &_from, NodeID const &_fromid, h256 const &_echo) : DiscoveryDatagram(
                    _from, _fromid, _echo)
            {
            }
            ...
            struct Neighbour
            {
                ...
                Neighbour(RLP const &_r) : endpoint(_r)
                {
                    node = h512(_r[3].toBytes());
                }
        ...
        struct NodeTableWarn : public LogChannel
        {
        ...
        struct NodeTableNote : public LogChannel
        {
            static const char *name();
        ...
        struct NodeTableMessageSummary : public LogChannel
        {
            static const char *name();
        ...
        struct NodeTableMessageDetail : public LogChannel
        {
            static const char *name();
        ...
        struct NodeTableConnect : public LogChannel
        {
            static const char *name();
        ...
        struct NodeTableEvent : public LogChannel
        {
            static const char *name();
        ...
        struct NodeTableTimer : public LogChannel
        {
            static const char *name();
        ...
        struct NodeTableUpdate : public LogChannel
        {
            static const char *name();
        ...
        struct NodeTableTriviaSummary : public LogChannel
        {
            static const char *name();
        ...
        struct NodeTableTriviaDetail : public LogChannel
        {
            static const char *name();
        ...
        struct NodeTableAllDetail : public LogChannel
        {
            static const char *name();

            static const int verbosity = 13;
        };

        struct NodeTableEgress : public LogChannel
        {
            static const char *name();
        ...
        struct NodeTableIngress : public LogChannel
        {
            static const char *name();

            static const int verbosity = 15;
        };
