...
namespace dev
{
    ...
    namespace p2p
    {
        ...
        struct NetWarn : public LogChannel
        {
        ...
        struct NetNote : public LogChannel
        {
            static const char *name();
        ...
        struct NetImpolite : public LogChannel
        {
            static const char *name();
        ...
        struct NetMessageSummary : public LogChannel
        {
            static const char *name();
        ...
        struct NetConnect : public LogChannel
        {
            static const char *name();
        ...
        struct NetMessageDetail : public LogChannel
        {
            static const char *name();
        ...
        struct NetTriviaSummary : public LogChannel
        {
            static const char *name();
        ...
        struct NetTriviaDetail : public LogChannel
        {
            static const char *name();
        ...
        struct NetAllDetail : public LogChannel
        {
            static const char *name();
        ...
        struct NetRight : public LogChannel
        {
            static const char *name();
        ...
        struct NetLeft : public LogChannel
        {
            static const char *name();
        ...
        struct NetP2PWarn : public LogChannel
        {
            static const char *name();
        ...
        struct NetP2PNote : public LogChannel
        {
            static const char *name();
        ...
        struct NetP2PConnect : public LogChannel
        {
            static const char *name();
        ...
        public:
            ...
            NodeIPEndpoint(bi::address _addr, uint16_t _udp, uint16_t _tcp) : address(_addr), udpPort(_udp),
                                                                              tcpPort(_tcp)
            {
            }
            ...
            {
                return bi::udp::endpoint(address, udpPort);
            }

            operator bi::tcp::endpoint() const
            {
                return bi::tcp::endpoint(address, tcpPort);
            }

            operator bool() const
            {
                return !address.is_unspecified() && udpPort > 0 && tcpPort > 0;
            }
        ...
        public:
            ...
            Node(Public _publicKey, NodeIPEndpoint const &_ip, PeerType _peerType = PeerType::Optional) : id(
                    _publicKey), endpoint(_ip), peerType(_peerType)
            {
            }
        ...
        class DeadlineOps
        {
            ...
            public:
                DeadlineOp(ba::io_service &_io, unsigned _msInFuture,
                           std::function<void(boost::system::error_code const &)> const &_f) : m_timer(
                        new ba::deadline_timer(_io))
                {
        ...
        public:
            DeadlineOps(ba::io_service &_io, unsigned _reapIntervalMs = 100) : m_io(_io),
                                                                               m_reapIntervalMs(_reapIntervalMs),
                                                                               m_stopped(false)
            {
                reap();
            }
