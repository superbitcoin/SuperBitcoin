...
namespace dev
{
    ...
    namespace p2p
    {
        ...
        public:
            ...
            Session(Host *_server, std::unique_ptr<RLPXFrameCoder> &&_io, std::shared_ptr<RLPXSocket> const &_s,
        ...
        private:
            ...
            {
                return isFramingAllowedForVersion(m_info.protocolVersion);
            }
        ...
        std::shared_ptr<PeerCap>
        capabilityFromSession(SessionFace const &_session, u256 const &_version = PeerCap::version())
        {
            try
            {
