...
namespace dev
{
    namespace eth
    {
        ...
        struct ImportRequirements
        {
            ...
            enum
            {
                ...
                OutOfOrderChecks = ValidSeal | CheckUncles |
                                   CheckTransactions, ///< Do all checks that can be done independently of prior blocks having been imported.
                InOrderChecks = Parent |
                                UncleParent, ///< Do all checks that cannot be done independently of prior blocks having been imported.
        ...
        struct TransactionSkeleton
        {
            ...
            std::string userReadable(bool _toProxy, std::function<std::pair<bool, std::string>(
