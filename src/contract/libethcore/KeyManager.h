    ...
    namespace eth
    {
        ...
        struct KeyInfo
        {
            ...
            KeyInfo(h256 const &_passHash, std::string const &_accountName,
                    std::string const &_passwordHint = std::string()) : passHash(_passHash), accountName(_accountName),
        ...
        public:
            ...
            {
                DirectICAP = 0, NoVanity, FirstTwo, FirstTwoNextTwo, FirstThree, FirstFour
            };

            KeyManager(std::string const &_keysFile = defaultPath(),
            ...
            Address
            importBrain(std::string const &_seed, std::string const &_accountName, std::string const &_seedHint);
            ...
            void importExisting(h128 const &_uuid, std::string const &_accountName, std::string const &_pass,
                                std::string const &_passwordHint);

            void importExisting(h128 const &_uuid, std::string const &_accountName)
            {
                importExisting(_uuid, _accountName, defaultPassword(), std::string());
            }
            ...
            Secret secret(Address const &_address, std::function<std::string()> const &_pass = DontKnowThrow,
            ...
            bool recode(Address const &_address, SemanticPassword _newPass,
            ...
            {
                return getDataDir("ethereum") + "/keys.info";
            }
        ...
        private:
            ...
            std::string
            getPassword(h256 const &_passHash, std::function<std::string()> const &_pass = DontKnowThrow) const;
            ...
            void write(std::string const &_pass,
                       std::string const &_keysFile) const;    // TODO: all passwords should be a secure string.
