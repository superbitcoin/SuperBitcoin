...
namespace dev
{
    namespace eth
    {
        ...
        public:
            ...
            virtual void verify(Strictness _s, BlockHeader const &_bi, BlockHeader const &_parent = BlockHeader(),
                                bytesConstRef _block = bytesConstRef()) const;

            /// Additional verification for transactions in blocks.
            virtual void
            verifyTransaction(ImportRequirements::value _ir, TransactionBase const &_t, BlockHeader const &_bi) const;
            ...
            ////////////////////////////////////////////////////////////// // sbtc
            void setSbtcSchedule(EVMSchedule _sbtcSchedule) const
            {
                sbtcSchedule = _sbtcSchedule;
            }

            EVMSchedule &getSbtcSchedule() const
            {
                return sbtcSchedule;
            }
        ...
        private:
            ...
            mutable EVMSchedule sbtcSchedule; // sbtc
