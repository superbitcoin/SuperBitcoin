...
namespace dev
{
    ...
    public:
        ...
        {
            if (!m_ethereum)
                BOOST_THROW_EXCEPTION(InterfaceNotSupported("eth"));
        ...
        std::shared_ptr<shh::WhisperHost> whisper() const
        {
            ...
            if (!w)
                BOOST_THROW_EXCEPTION(InterfaceNotSupported("shh"));
            return w;
        }
        ...
        {
            return m_ethereum.get()->networkId();
        }
