...
namespace dev
{
    ...
    {
    public:
        InvariantChecker(HasInvariants *_this, char const *_fn, char const *_file, int _line) : m_this(_this),
                                                                                                m_function(_fn),
                                                                                                m_file(_file),
                                                                                                m_line(_line)
        {
        ...
        static void
        checkInvariants(HasInvariants const *_this, char const *_fn, char const *_file, int line, bool _pre);
...
#define DEV_INVARIANT_CHECK_HERE (void)0;
    ...
    {
    public:
        TimerHelper(std::string const &_id, unsigned _msReportWhenGreater = 0) : m_t(
