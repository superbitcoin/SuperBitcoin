...
struct IpcSendChannel : public LogChannel
{
...
struct IpcReceiveChannel : public LogChannel
{
    static const char *name()
    {
        return "I<";
...
template<class S>
IpcServerBase<S>::IpcServerBase(string const &_path):
        m_path(_path)
{
}
...
{
    template
    class IpcServerBase<int>;

    template
    class IpcServerBase<void *>;
}
