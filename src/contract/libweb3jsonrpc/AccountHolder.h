    ...
    namespace eth
    {
        ...
        public:
            SimpleAccountHolder(std::function<Interface *()> const &_client,
                                ...
                                std::function<bool(TransactionSkeleton const &,
                                                   bool)> _getAuthorisation = std::function<bool(
                                        TransactionSkeleton const &, bool)>()) :
            ...
            virtual bool
            unlockAccount(Address const &_account, std::string const &_password, unsigned _duration) override;
