...
namespace dev
{
    ...
    namespace eth
    {
        ...
        struct BlockChainChat : public LogChannel
        {
        ...
        struct BlockChainNote : public LogChannel
        {
            static const char *name();

            static const int verbosity = 3;
        };

        struct BlockChainWarn : public LogChannel
        {
            static const char *name();
        ...
        struct BlockChainDebug : public LogChannel
        {
            static const char *name();
        ...
        public:
            ...
            BlockChain(ChainParams const &_p, std::string const &_path, WithExisting _we = WithExisting::Trust,
            ...
            std::pair<ImportResult, ImportRoute>
            attemptImport(bytes const &_block, OverlayDB const &_stateDB, bool _mutBeNew = true) noexcept;
            ...
            {
                return transactionHashes(currentHash());
            }
            ...
            {
                return uncleHashes(currentHash());
            }
            ...
            h256 numberHash(unsigned _i) const
            {
                if (!_i)
                    return genesisHash();
                return queryExtras<BlockHash, uint64_t, ExtraBlockHash>(_i, m_blockHashes, x_blockHashes,
                                                                        NullBlockHash).value;
            }
            ...
            {
                return lastHashes(m_lastBlockHash);
            }
            ...
            {
                return queryExtras<BlocksBlooms, ExtraBlocksBlooms>(_chunkId, m_blocksBlooms, x_blocksBlooms,
                                                                    NullBlocksBlooms);
            }
            ...
            std::vector<unsigned>
            withBlockBloom(LogBloom const &_b, unsigned _earliest, unsigned _latest, unsigned _topLevel,
            ...
            {
                return transactions(currentHash());
            }
            ...
            void rebuild(std::string const &_path,
             ...
             * @endcode
             */
            std::tuple<h256s, h256, unsigned>
            treeRoute(h256 const &_from, h256 const &_to, bool _common = true, bool _pre = true,
            ...
            VerifiedBlockRef verifyBlock(bytesConstRef _block, std::function<void(Exception &)> const &_onBad,
        ...
        private:
            ...
            T queryExtras(K const &_h, std::unordered_map<K, T> &_m, boost::shared_mutex &_x, T const &_n,
                          ldb::DB *_extrasDB = nullptr) const
            {
                {
                    ReadGuard l(_x);
                    auto it = _m.find(_h);
            ...
            T queryExtras(h256 const &_h, std::unordered_map<h256, T> &_m, boost::shared_mutex &_x, T const &_n,
                          ldb::DB *_extrasDB = nullptr) const
            {
            ...
            std::function<void(
                    Exception &)> m_onBad;                                    ///< Called if we have a block that doesn't verify.
            std::function<void(
                    BlockHeader const &)> m_onBlockImport;                                        ///< Called if we have imported a new block into the db
