...
namespace dev
{
    ...
    namespace eth
    {
        ...
        struct BlockChat : public LogChannel
        {
        ...
        struct BlockTrace : public LogChannel
        {
            static const char *name();
        ...
        struct BlockDetail : public LogChannel
        {
            static const char *name();
        ...
        struct BlockSafeExceptions : public LogChannel
        {
            static const char *name();
        ...
        public:
            ...
            {
                return m_receipts[_i];
            }

            /// Get the list of pending transactions.
            LogEntries const &log(unsigned _i) const
            {
                return m_receipts[_i].log();
            }
            ...
            std::pair<TransactionReceipts, bool>
            sync(BlockChain const &_bc, TransactionQueue &_tq, GasPricer const &_gp, unsigned _msTimeout = 100);
        ...
        private:
            ...
            void ensureCached(std::unordered_map<Address, Account> &_cache, Address const &_a, bool _requireCode,
                              bool _forceCreate) const;
