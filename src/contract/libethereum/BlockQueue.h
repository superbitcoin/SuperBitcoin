...
namespace dev
{
    ...
    namespace eth
    {
        ...
        struct BlockQueueChannel : public LogChannel
        {
        ...
        struct BlockQueueTraceChannel : public LogChannel
        {
            static const char *name();
...
#define cblockq dev::LogOutputStream<dev::eth::BlockQueueChannel, true>()
        ...
        private:
            ...
            std::vector<std::pair<h256, bytes>>
            removeRange(typename BlockMultimap::iterator _begin, typename BlockMultimap::iterator _end)
            {
