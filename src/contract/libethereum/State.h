...
#ifndef ETH_FATDB         //sbtc wanghongyang 默认使用
#define ETH_FATDB 1
#endif
        ...
        public:
            ...
            static OverlayDB
            openDB(std::string const &_path, h256 const &_genesisHash, WithExisting _we = WithExisting::Trust);
            ...
            execute(EnvInfo const &_envInfo, SealEngineFace const &_sealEngine, Transaction const &_t,
            ...
            virtual void addBalance(Address const &_id, u256 const &_amount); // sbtc
