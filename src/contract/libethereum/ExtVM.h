    ...
    namespace eth
    {
        ...
        public:
            ...
            ExtVM(State &_s, EnvInfo const &_envInfo, SealEngineFace const &_sealEngine, Address _myAddress,
                  ...
                  bytesConstRef _code, h256 const &_codeHash, unsigned _depth = 0) :
                    ExtVMFace(_envInfo, _myAddress, _caller, _origin, _value, _gasPrice, _data, _code.toBytes(),
                              _codeHash, _depth), m_s(_s), m_sealEngine(_sealEngine)
            {
            ...
            /// Read address's code.
            virtual bytes const &codeAt(Address _a) override final
            {
                return m_s.code(_a);
            }
            ...
            virtual h160
            create(u256 _endowment, u256 &io_gas, bytesConstRef _code, OnOpFunc const &_onOp = {}) override final;
            ...
            virtual u256 balance(Address _a) override final
            {
            ...
            {
                return m_sealEngine.evmSchedule(envInfo());
            }
