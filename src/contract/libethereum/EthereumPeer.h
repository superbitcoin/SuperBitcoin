...
namespace dev
{
    namespace eth
    {
        ...
        public:
            ...
            virtual void
            onPeerNewHashes(std::shared_ptr<EthereumPeer> _peer, std::vector<std::pair<h256, u256>> const &_hashes) = 0;
        ...
        public:
            ...
            virtual std::pair<bytes, unsigned>
            blockHeaders(RLP const &_blockId, unsigned _maxHeaders, u256 _skip, bool _reverse) const = 0;
        ...
        public:
            /// Basic constructor.
            EthereumPeer(std::shared_ptr<p2p::SessionFace> _s, p2p::HostCapabilityFace *_h, unsigned _i,
            ...
            void
            init(unsigned _hostProtocolVersion, u256 _hostNetworkId, u256 _chainTotalDifficulty, h256 _chainCurrentHash,
                 h256 _chainGenesisHash, std::shared_ptr<EthereumHostDataFace> _hostData,
