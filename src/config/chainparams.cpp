...
bool CChainParams::AddCheckPoint(int const height, const uint256 hash) const
{
    ...
    auto it = std::find_if(checkpointData.mapCheckpoints.begin(), checkpointData.mapCheckpoints.end(),
                           [&](std::map<int, uint256>::value_type pair)
...
public:
    CMainParams()
    {
        ...
        consensus.SBTCContractForkHeight = 531806 - 1; // 531806 is the first new block height
        ...
        checkpointData = (CCheckpointData){
                {
                        ...
                        {542051, uint256S("0x00000000000000010ae3756bcb9cd1ef5ad20ad6de1e43d16cdf231f9e1be430")},
                        {548824, uint256S("0x00000000000000005376ad589e36b8dfea061b637451a4ec9ea388bc04777991")},
...
public:
    CTestNetParams()
    {
        ...
        consensus.SBTCContractForkHeight = 530555 - 1; // 524000 is the first new block height
        consensus.vDeployments[Consensus::DEPLOYMENT_SBTC_CONTRACT].bit = VERSIONBITS_SBTC_CONTRACT;
        ...
        vSeeds.emplace_back("seedtest.superbtc.org", false);
...
public:
    CRegTestParams()
    {
        ...
        consensus.SBTCContractForkHeight = 800 - 1; // 1500 is the first new block height
        consensus.vDeployments[Consensus::DEPLOYMENT_SBTC_CONTRACT].bit = VERSIONBITS_SBTC_CONTRACT;
