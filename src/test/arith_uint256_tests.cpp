...
BOOST_FIXTURE_TEST_SUITE(arith_uint256_tests, BasicTestingSetup)
    ...
    void
    shiftArrayRight(unsigned char *to, const unsigned char *from, unsigned int arrayLength, unsigned int bitsToShift)
    {
    ...
    void
    shiftArrayLeft(unsigned char *to, const unsigned char *from, unsigned int arrayLength, unsigned int bitsToShift)
    {
        for (unsigned int T = 0; T < arrayLength; ++T)
        {
            if (T >= bitsToShift / 8)
...
#define CHECKASSIGNMENTOPERATOR(_A_, _B_, _OP_)                           \
    ...
    BOOST_AUTO_TEST_CASE(multiply)
    {
        ...
        BOOST_CHECK(
                (R2L * 0x87654321UL).ToString() == "23f7816e30c4ae2017257b7a0fa64d60402f5234d46e746b61c960d09a26d070");
    }
