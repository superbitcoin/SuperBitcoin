...
BOOST_AUTO_TEST_SUITE(tx_validationcache_tests)
    ...
    BOOST_FIXTURE_TEST_CASE(tx_mempool_block_doublespend, TestChain100Setup)
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            uint256 hash = SignatureHash(scriptPubKey, spends[i], 0, SIGHASH_ALL | SIGHASH_SBTC_FORK, 0,
                                         SIGVERSION_BASE);
            BOOST_CHECK(coinbaseKey.Sign(hash, vchSig));
            vchSig.push_back((unsigned char)(SIGHASH_ALL | SIGHASH_SBTC_FORK));
                                        ...
                                        bool upgraded_nop)
    {
        ...
        for (uint32_t test_flags = 0; test_flags < (1U << 16); test_flags += 1)
        {
            ...
            if (ret && add_to_cache)
            {
                ...
                BOOST_CHECK(
                        CheckInputs(tx, state, pcoinsTip, true, test_flags, true, add_to_cache, txdata, &scriptchecks));
    ...
    BOOST_FIXTURE_TEST_CASE(checkinputs_test, TestChain100Setup)
    {
        ...
        // spend_tx is invalid according to DERSIG
        {
            ...
            BOOST_CHECK(!CheckInputs(spend_tx, state, pcoinsTip, true, SCRIPT_VERIFY_P2SH | SCRIPT_VERIFY_DERSIG, true,
            ...
            std::vector<CScriptCheck> scriptchecks;
            BOOST_CHECK(
                    CheckInputs(spend_tx, state, pcoinsTip, true, SCRIPT_VERIFY_P2SH | SCRIPT_VERIFY_DERSIG, true, true,
            ...
            ValidateCheckInputsForAllFlags(spend_tx,
                                           SCRIPT_VERIFY_DERSIG | SCRIPT_VERIFY_LOW_S | SCRIPT_VERIFY_STRICTENC, false,
                                           false);
        ...
        // Test CHECKLOCKTIMEVERIFY
        {
            ...
            BOOST_CHECK(
                    CheckInputs(invalid_with_cltv_tx, state, pcoinsTip, true, SCRIPT_VERIFY_CHECKLOCKTIMEVERIFY, true,
                                true, txdata, nullptr));
        }
        ...
        // TEST CHECKSEQUENCEVERIFY
        {
            ...
            BOOST_CHECK(
                    CheckInputs(invalid_with_csv_tx, state, pcoinsTip, true, SCRIPT_VERIFY_CHECKSEQUENCEVERIFY, true,
                                true, txdata, nullptr));
        }
        ...
        // for the same tx with a different witness.
        {
            ...
            ProduceSignature(
                    MutableTransactionSignatureCreator(&keystore, &valid_with_witness_tx, 0, 11 * CENT, SIGHASH_ALL),
...

        {
            ...
            {
                SignatureData sigdata;
                ProduceSignature(MutableTransactionSignatureCreator(&keystore, &tx, i, 11 * CENT, SIGHASH_ALL),
            ...
            BOOST_CHECK(!CheckInputs(tx, state, pcoinsTip, true, SCRIPT_VERIFY_P2SH | SCRIPT_VERIFY_WITNESS, true, true,
                                     txdata, nullptr));
