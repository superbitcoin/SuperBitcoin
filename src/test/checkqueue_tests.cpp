// Copyright (c) 2012-2017 The Super Bitcoin Core developers
...
BOOST_FIXTURE_TEST_SUITE(checkqueue_tests, TestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(test_CheckQueue_Correct_Random)
    {
        ...
        for (size_t i = 2; i < 100000; i += std::max((size_t)1, (size_t)InsecureRandRange(
                std::min((size_t)1000, ((size_t)100000) - i))))
            range.push_back(i);
        Correct_Queue_range(range);
    }
