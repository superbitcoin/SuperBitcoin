...
bool CCoinsViewDB::BatchWrite(CCoinsMap &mapCoins, const uint256 &hashBlock)
{
    ...
    size_t count = 0;
    size_t changed = 0;
    size_t batch_size = (size_t)gArgs.GetArg<int64_t>("-dbbatchsize", nDefaultDbBatchSize);
    int crash_simulate = gArgs.GetArg<int>("-dbcrashratio", 0);
...
CBlockTreeDB::CBlockTreeDB(size_t nCacheSize, bool fMemory, bool fWipe) : CDBWrapper(GetDataDir() / "blocks" / "index",
