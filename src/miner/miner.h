...
#include "contract-api/contractcomponent.h"  //sbtc-vm
...
private:
    ...
    /** Add a contract tx to the block*/
    ...
    void SortForBlock(const CTxMemPool::setEntries &package, CTxMemPool::txiter entry,
